...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    joystick.button(1).onTrue(Commands.runOnce(() -> turret1.setPosition(Degrees.of(45))));
    joystick.button(2).onTrue(Commands.runOnce(() -> turret1.setPosition(Degrees.of(200))));
  }
}
