...
public class Pathing {
  ...
  public boolean isEndEffectorReadyForElevator() {
    ...
    return (Math.abs(endEffector.getAppliedVolts() - SCORE_END_EFFECTOR_VOLTS)
            <= END_EFFECTOR_TOLERANCE_VOLTS)
  ...
  public boolean isReadyToScore() {
    ...
    return (isEndEffectorReadyForElevator()
        && (Math.abs(elevator.getCurrentMeters() - SCORE_ELEVATOR_METERS)
